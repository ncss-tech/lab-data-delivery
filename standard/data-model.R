...
destination_db <- DBI::dbConnect(RSQLite::SQLite(), bigint = "integer64", dbname = "ncss_labdata_relationships6.sqlite")
scd_dm <- copy_dm_to(
  destination_db, 
  scd_dm, 
  temporary = FALSE,
...
fp <- "C:/workspace2/test10.sqlite"
dm_con <- dm_from_con(DBI::dbConnect(RSQLite::SQLite(), dbname = fp))
dm_con
