...
go
	  ...
	  DROP TABLE IF EXISTS SDA_Major_And_Trace_Elements_And_Oxides
...
LEFT JOIN dbo.bridge_proced_ss AS b ON r.procedure_key = b.procedure_key AND 
            ...
            WHERE  (r.analyte_key IN (491, 490, 492, 496, 493, 494, 498, 495, 497, 499, 500, 1207, 1130, 1131, 1132, 1133, 501, 503, 502, 504, 507, 506, 1137, 508, 509, 505, 
                         1134, 1135, 1139, 1136, 1151, 1138, 1140, 510, 818, 819, 820)) AND (r.result_reliability IS NULL OR
...
SELECT  natural_key AS labsampnum, result_source_key,  prep_code,
      (SELECT        TOP (1) ISNULL(dbo.bridge_proced_ss.proced_code, '') AS Expr1
                               ...
                               WHERE        (result_light.result_type = 'layer analyte') AND (result_light.result_value <> '') AND (NOT (result_light.result_value IS NULL)) AND 
                                                         ...
                                                         result_light.result_reliability = '0') AND (result_light.analyte_key IN (491, 490, 492, 496, 493, 494, 498, 495, 497, 499, 500, 1207))) 
                         AS major_element_method,
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_5.result_value, '8.0') AS decimal(8, 0)) AS Expr1
                               FROM            result_light AS result_5 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_36.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_36 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_35.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_35 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_34.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_34 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_33.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_33 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_32.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_32 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_31.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_31 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_30.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_30 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_27.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_27 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_26.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_26 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_25.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_25 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_24.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_24 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_23.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_23 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_22.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_22 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_21.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_21 INNER JOIN
                             ...
                             (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_20.result_value, '8.2') AS decimal(8, 2)) AS Expr1
                               FROM            result_light AS result_20 INNER JOIN
...
SELECT labsampnum, result_source_key,prep_code,[major_element_method], [aluminum_major_element], [calcium_major_element], [iron_major_element], [potassium_major_element], [magnesium_major_element], [manganese_major_element], [sodium_major_element], [phosphorus_major_element], [silicon_major_element], [strontium_major_element], [titanium_major_element], [zirconium_major_element], [trace_element_method], [silver_trace_element], [arsenic_trace_element], [barium_trace_element], [beryllium_trace_element], [cadmium_trace_element], [cobalt_trace_element], [chromium_trace_element], [copper_trace_element], [mercury_trace_element], [manganese_trace_element], [molybdenum_trace_element], [nickel_trace_element], [phosphorus_trace_element], [lead_trace_element], [antimony_trace_element], [selenium_trace_element], [tin_trace_element], [strontium_trace_element], [thallium_trace_element], [vanadium_trace_element], [tungsten_trace_element], [zinc_trace_element], [iron_oxide_total], [aluminum_oxide_total], [potassium_oxide_total]

INTO SDA_Major_And_Trace_Elements_And_Oxides
FROM #tempXX 
GROUP BY labsampnum, result_source_key,prep_code,[major_element_method], [aluminum_major_element], [calcium_major_element], [iron_major_element], [potassium_major_element], [magnesium_major_element], [manganese_major_element], [sodium_major_element], [phosphorus_major_element], [silicon_major_element], [strontium_major_element], [titanium_major_element], [zirconium_major_element], [trace_element_method], [silver_trace_element], [arsenic_trace_element], [barium_trace_element], [beryllium_trace_element], [cadmium_trace_element], [cobalt_trace_element], [chromium_trace_element], [copper_trace_element], [mercury_trace_element], [manganese_trace_element], [molybdenum_trace_element], [nickel_trace_element], [phosphorus_trace_element], [lead_trace_element], [antimony_trace_element], [selenium_trace_element], [tin_trace_element], [strontium_trace_element], [thallium_trace_element], [vanadium_trace_element], [tungsten_trace_element], [zinc_trace_element], [iron_oxide_total], [aluminum_oxide_total], [potassium_oxide_total]
...
GO
	...
	CREATE INDEX  SDA_Major_And_Trace_Elements_And_Oxides_idx1c ON  SDA_Major_And_Trace_Elements_And_Oxides (labsampnum, result_source_key) INCLUDE (prep_code)
	CREATE INDEX  SDA_Major_And_Trace_Elements_And_Oxides_result_source_key_idx2 ON  SDA_Major_And_Trace_Elements_And_Oxides (result_source_key )
	CREATE INDEX SDA_Major_And_Trace_Elements_And_Oxides_prep_code_idx5 ON  SDA_Major_And_Trace_Elements_And_Oxides (prep_code)